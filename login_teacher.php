...
<body>
	...
	<div class="row" style="margin-top:20px">
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" action="login_validate_t.php" method="post">
				<fieldset>
					<h2>Please Sign In <br> ---TEACHER SIGN IN---</h2>
					<p> Please go to student sign in if you are not a tutor or admin </p>
					<hr class="colorgraph">
					...
					<div class="row">
						...
						<div class="col-xs-6 col-sm-6 col-md-6">
							<a href="login.php">
								<button  type="button" class="btn btn-lg btn-secondary btn-block">Student Login </button> 
							</a>
						</div>
					</div>
					<?php 
