            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-9">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" action="edit_profile.php" method="post">
                                    <div class="form-group">
                                        <h3 class="text-center">--User Profile Update--</h3>
                                        <div class="form-group">
                                            <label class="col-md-12 mb-0"> <b>User ID </b> </label>
                                            <input type="text" name="ID" value="<?php echo $_POST['ID'];?>" readonly>
                                        </div>
                                        <label class="col-md-12 mb-0">Name</label>
                                        <div class="col-md-12">
                                            <input name="name"required type="text" placeholder="Johnathan Doe"
                                                class="form-control ps-0 form-control-line" value=" <?php echo $_POST['name'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Nickname</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="The Jack"
                                                class="form-control ps-0 form-control-line" name="nickname"
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0"> <b> User points number: <?php echo $_POST['Points'];?> </b> </label>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-12">Award points</label>
                                        <div class="col-sm-12 border-bottom">
                                            <select name="add_points" class="form-select shadow-none border-0 ps-0 form-control-line" required>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 d-flex">
                                            <button class="btn btn-success mx-auto mx-md-0 text-white" type="sumbit">Update
                                                Profile</button>
                                        </div>
                                    </div>
                                </form>
